...
def place_entities(
    room: RectangularRoom, dungeon: GameMap, z: int, maximum_monsters: int, maximum_items: int
) -> None:
    ...
    for i in range(number_of_monsters):
        ...
        if not any(entity.x == x and entity.y == y for entity in dungeon.entities):
            if random.random() < 0.8:
                entity_factories.orc.spawn(dungeon, z, x, y)
            else:
                entity_factories.troll.spawn(dungeon, z, x, y)
...
def generate_dungeon(
    ...
    for d in range(int(map_depth / 2), -1, -1):
        ...
        if last_stairs_room:
            dungeon.tiles[d][last_stairs_room.inner] = tile_types.floor
            dungeon.tiles[d][last_stairs_room.center[0]+1, last_stairs_room.center[1]+1] = tile_types.up_stairs
                
            rooms.append(last_stairs_room)
        ...
        for r in range(max_rooms):
            ...
            place_entities(new_room, dungeon, d, max_monsters_per_room, max_items_per_room)
