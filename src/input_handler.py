...
class AskUserEventHandler(EventHandler):
    ...
    def ev_mousebuttondown(self, event: tcod.event.MouseButtonDown) -> Optional[actions.Action]:
        """By default any mouse click exits this input handler."""
        return self.on_exit()

    def on_exit(self) -> Optional[actions.Action]:
...
class InventoryEventHandler(AskUserEventHandler):
    ...
    def on_item_selected(self, item: Item) -> Optional[actions.Action]:
